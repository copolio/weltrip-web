...
def home(request):
    ...
    if request.user.is_authenticated: #추천 장소 출력 - 작성자: 김기정
        ...
        return render(request, 'planner/home.html', context = {'popular1': sites1, 'popular2' : sites2, 'recimg' : recimg, 'rectitle' : rectitle, 'recaddr' : recaddr, 'recSpots' : recSpots, 'reckeys' : reckeys,})
    else:
